...
export type AdminExperiencePhotoRouteDependencies = {
...
const DEFAULT_DEPENDENCIES: AdminExperiencePhotoRouteDependencies = {
  createClient,
  createAdminClient,
  resolveAdminAccess,
...
export async function handleAdminExperiencePhotoReorder(
  request: NextRequest,
  context: RouteContext,
  dependencies: AdminExperiencePhotoRouteDependencies = DEFAULT_DEPENDENCIES
) {
  try {
