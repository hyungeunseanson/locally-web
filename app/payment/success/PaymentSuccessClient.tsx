...
// Keep this client page only for compatibility when a legacy success link still
// arrives with an `orderId`. Bare `/payment/success` requests are gated at the
// server page and should not remain as a standalone public landing page.
