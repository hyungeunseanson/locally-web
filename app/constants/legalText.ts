...
- 개인정보를 제공받는 자 : 결제 처리, 예약 이행, 본인확인, 법령상 의무 대응에 필요한 제휴사 및 기관
- 제공받는 자의 개인정보 이용목적 : 예약 확인, 결제 및 정산 처리, 본인 확인, 분쟁 대응 및 법령상 의무 이행
- 제공하는 개인정보 항목 : 성명, 연락처, 예약 및 결제 처리에 필요한 정보
- 제공받는 자의 보유, 이용기간 : 관련 법령 또는 계약상 필요한 기간


제4조(개인정보처리의 위탁)
① 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.

- 위탁받는 자 (수탁자) : 결제대행 및 에스크로 서비스 제공사
- 위탁하는 업무의 내용 : 결제 승인, 결제 보안, 정산 연계 업무

- 위탁받는 자 (수탁자) : 클라우드 및 서비스 인프라 운영사
- 위탁하는 업무의 내용 : 서비스 호스팅, 데이터 보관, 장애 대응 및 로그 관리

- 위탁받는 자 (수탁자) : 메시지·이메일 발송 및 고객지원 협력사
- 위탁하는 업무의 내용 : 고객 문의 접수, 답변 안내, 알림 발송 업무

- 위탁받는 자 (수탁자) : 본인확인 및 인증 서비스 제공사
- 위탁하는 업무의 내용 : 본인확인, 계정 보호, 이상 거래 방지 업무
...
③ 실제 적용되는 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.
...
1. 홈페이지 회원 가입 및 관리
필수항목 : 이메일 주소 또는 소셜 로그인 식별자, 비밀번호(이메일 가입 시), 성명 또는 닉네임, 기본 언어 설정
선택항목 : 프로필 사진, 자기소개, 거주 도시, 선호 정보

2. 재화 또는 서비스 제공
필수항목 : 예약자명, 연락처, 예약 및 결제 처리 정보, 호스트 정산에 필요한 계좌 및 예금주 정보(호스트에 한함)
선택항목 : 요청사항, 여행 선호, 영수증 발행 정보
...
라. Google을 포함한 제3자 광고 사업자는 쿠키를 사용하여 이용자의 본 사이트 또는 다른 웹사이트 방문 기록을 바탕으로 광고를 게재할 수 있습니다.
마. Google 광고 쿠키를 통해 Google 및 그 파트너는 이용자의 본 사이트 또는 인터넷상의 다른 사이트 방문 기록을 바탕으로 맞춤 광고를 게재할 수 있습니다.
바. 이용자는 Google 광고 설정(https://adssettings.google.com/)에서 맞춤 광고를 사용 중지할 수 있습니다. 지역별 법령이 적용되는 경우 사이트에 표시되는 동의 관리 화면에서 동의 여부와 광고 설정을 변경할 수 있습니다.
사. 동의를 거부하거나 맞춤 광고를 사용 중지한 경우 개인 맞춤이 아닌 광고가 제공되거나 광고 제공이 제한될 수 있습니다. Google의 개인정보 처리에 관한 자세한 내용은 https://policies.google.com/privacy 에서 확인할 수 있습니다.
아. 회사는 이용자가 분석 쿠키에 동의한 경우에만 Google Analytics를 사용하여 페이지 방문과 체험 검색·예약 흐름을 통계적으로 분석합니다. 이름, 이메일, 전화번호 및 자유 입력 검색어는 Google Analytics로 전송하지 않으며, 이용자는 사이트의 동의 관리 화면에서 분석 동의를 변경할 수 있습니다.
...
[투어 취소 및 환불]
파트너약관 제16조 제2항과 같이 여행요금 지급이 이루어진 후 투어 개시일 이전에 여행계약을 임의로 해제하는 경우, 해제 통보 시점에 따라 다음 기준이 적용됩니다.

- 체험일 당일 또는 이미 지난 일정 취소: 환불 불가
- 그 외 결제일과 동일한 한국 시간(KST) 기준 날짜에 취소한 경우: 여행요금 전액 환불
- 여행시작 20일 전까지 (~20일) 통보 시: 여행요금 전액 환불
- 여행시작 8일 전까지 (19~8일) 통보 시: 여행요금의 80% 환불
- 여행시작 2일 전까지 (7~2일) 통보 시: 여행요금의 70% 환불
- 여행시작 1일 전까지 (~1일) 통보 시: 여행요금의 40% 환불

호스트 사유로 투어가 취소되거나 회사가 진행 불가를 확인한 경우에는 여행요금을 전액 환불합니다.
