...
export default function LoginModal({ isOpen, onClose, onLoginSuccess }: LoginModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-3 md:p-4 animate-in fade-in duration-200">
      <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={onClose}></div>

      <div className={`bg-white w-full ${mode === 'SIGNUP' ? 'max-w-[374px] md:max-w-[480px]' : 'max-w-[344px] md:max-w-[420px]'} rounded-[22px] md:rounded-2xl shadow-2xl overflow-hidden relative z-10 animate-in zoom-in-95 duration-200 transition-all`}>
