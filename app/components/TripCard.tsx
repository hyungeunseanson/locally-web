...
export default function TripCard({ id, image, title, date, host, isReviewed, onReviewClick }: TripCardProps) {
  return (
    <div className="border border-slate-200 rounded-2xl overflow-hidden hover:shadow-md active:scale-[0.98] transition-all duration-200 flex flex-col h-full bg-white">
