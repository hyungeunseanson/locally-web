        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden flex flex-col h-full animate-in fade-in zoom-in-95 duration-200">
            ...
            <div className="flex-1 overflow-y-auto bg-slate-50 relative p-6">
                {!isPreview ? (
                    ...
                    <div className="prose prose-sm text-[13px] max-w-none prose-slate text-slate-800 prose-p:text-slate-800 prose-p:text-[13px] prose-strong:text-slate-900 prose-li:text-slate-800 prose-li:text-[13px] prose-img:rounded-xl prose-img:shadow-sm prose-img:max-h-[140px] prose-img:w-auto prose-img:object-contain prose-img:my-2 prose-headings:font-bold prose-headings:text-slate-900 prose-a:text-blue-600">
                        {content ? (
