      ...
      <div className="space-y-8 flex-1 overflow-y-auto scrollbar-hide">
        <div>
          ...
          <div className="space-y-1">
            ...
            />
            <NavButton active={activeTab === 'USERS'} onClick={() => handleTabChange('USERS')} icon={<Users size={18} />} label="Member Management" count={counts.online > 0 ? `${counts.online} 접속` : undefined} />
          </div>
        </div>
