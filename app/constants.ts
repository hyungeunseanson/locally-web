...
export const LOCALLY_SERVICES = [
    { id: 1, title: '일본 전화 예약 · 문의 대행', price: 4500, image: 'https://images.unsplash.com/photo-1514933651103-005eec06c04b', desc: '식당·숙소·교통·재고 문의까지 일본 현지 전화로 대신 확인해드립니다.', href: '/proxy-bookings/new' },
