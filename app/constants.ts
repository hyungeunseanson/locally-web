...
export const LOCALLY_SERVICES = [
    ...
    { id: 5, title: '현지인 동행/통역 맞춤 의뢰', price: 35000, image: '/images/services/local-companion-interpreter.jpg', desc: '시간당 35,000원부터. 결제 후 현지 담당자가 적합한 호스트를 직접 배정합니다.', href: '/services/intro' },
  ];
