      ...
      <div className="py-6 md:py-8">
        ...
        <div className="relative w-full rounded-[18px] border border-white bg-[linear-gradient(180deg,rgba(255,255,255,0.99)_0%,rgba(251,251,252,0.99)_100%)] p-5 text-center shadow-[0_2px_8px_rgba(255,255,255,0.92),0_10px_22px_rgba(15,23,42,0.12),0_16px_30px_rgba(148,163,184,0.22)] ring-1 ring-slate-100 transition-shadow hover:shadow-[0_2px_10px_rgba(255,255,255,0.92),0_12px_24px_rgba(15,23,42,0.14),0_18px_34px_rgba(148,163,184,0.24)] md:rounded-[22px] md:p-7">
          ...
          <div className="pointer-events-none relative z-10">
            ...
            <div className="mb-1.5 md:mb-2 flex items-center justify-center gap-1.5">
              <h4 className="text-[18px] md:text-[34px] font-semibold leading-none">{props.name}</h4>
              {props.isSuperhost ? (
                <SuperhostBadgeTrigger
                  className="pointer-events-auto"
                  iconSize={18}
                  showLabel={false}
                  testIdPrefix="experience-host-superhost-badge"
                />
              ) : null}
            </div>
