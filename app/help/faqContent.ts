    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: '주말에는 응답이 조금 늦어질 수 있습니다. 영업시간 안에 여러 번 시도했는데도 연결되지 않거나 만석이면, 요청이 완료 처리될 수 있습니다. 진행 상황과 결과는 1:1 문의함에서 안내드립니다.',
        ...
        },
        {
          id: 'proxy-results',
          q: '진행 결과는 어디서 확인하나요?',
          a: '전화 예약 요청 후 운영팀 답변과 통화 결과는 1:1 문의함에서 확인할 수 있습니다. 새 답변이 오면 알림으로도 알려드립니다.',
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: 'fee-tax',
          q: '수수료는 어떻게 반영되나요?',
          a: '등록한 체험 금액의 20%는 플랫폼 수수료로 반영됩니다. 플랫폼 수수료에는 결제 운영, 서버 유지, 고객 지원, 안전한 예약 관리 등 서비스 운영에 필요한 비용이 포함됩니다. 정산 금액은 플랫폼 수수료가 반영된 금액을 기준으로 확인할 수 있습니다.',
          searchTerms: ['수수료', '플랫폼 수수료', '20%', '80%', 'commission', 'platform fee'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          a: '20% of the experience price you set is applied as the platform fee. The platform fee covers payment operations, server maintenance, customer support, and safe booking management. Your payout amount is shown after the platform fee is reflected.',
          searchTerms: ['fees', 'platform fee', '20%', '80%', 'commission'],
        },
      ],
    },
    {
  ...
  host: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          id: 'fee-tax',
          q: 'プラットフォーム手数料はどのように反映されますか？',
          a: '設定した体験料金の20%はプラットフォーム手数料として反映されます。プラットフォーム手数料には、決済運営、サーバー維持、カスタマーサポート、安全な予約管理など、サービス運営に必要な費用が含まれます。精算金額はプラットフォーム手数料が反映された金額として確認できます。',
          searchTerms: ['手数料', 'プラットフォーム手数料', '20%', '80%', 'commission'],
        },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          id: 'fee-tax',
          q: '平台服务费会如何反映？',
          a: '您设置的体验价格的20%将作为平台服务费。平台服务费包含支付运营、服务器维护、客户支持和安全预订管理等服务运营所需成本。结算金额会以扣除平台服务费后的金额显示。',
          searchTerms: ['手续费', '平台服务费', '20%', '80%', 'commission'],
        },
      ],
    },
    {
