...
import SiteHeader from '@/app/components/SiteHeader'; // ✅ 헤더 적용
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <TripCard image="https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e" title="기모노 입고 다도 체험" date="2025년 12월" host="Sakura"/>
            <TripCard image="https://images.unsplash.com/photo-1551632811-561732d1e306" title="홋카이도 설국 스키 레슨" date="2025년 1월" host="Yuki"/>
