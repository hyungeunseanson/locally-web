...
const COPY: Record<HostRegisterLocale, HostRegisterCopy> = {
  ko: {
    ...
    phoneHelp: '운영팀이 중요한 일정 변경 시 연락할 수 있는 번호예요.',
    emailLabel: '이메일 주소',
    ...
    selfIntroLabel: '자기소개',
    selfIntroHelp: '보여주고 싶은 게스트의 언어로 작성해주세요.\n예: 한국인 게스트에게 보여주고 싶다면 한국어로 작성하면 됩니다.',
    ...
    idUploadHelpBody: '신분증은 승인 검토와 본인 확인 및 정산에만 사용되며 게스트에게 공개되지 않습니다.',
    ...
    payoutGuideBody: '계좌 정보는 수익 정산에 바로 연결됩니다. 은행명, 계좌번호, 예금주가 실제 정보와 다르면 지급이 지연될 수 있어요. 본인 명의 계좌를 정확히 입력하는 것이 가장 중요합니다. 등록한 체험 금액의 20%는 플랫폼 수수료로 반영됩니다.',
    ...
    step8Summary3: '등록 내용과 실제 진행 내용을 최대한 일치시켜야 게스트 신뢰가 유지됩니다.',
  ...
  en: {
    ...
    phonePlaceholder: '010-1234-5678',
    phoneHelp: 'This is the number our operations team can use for important schedule changes.',
    ...
    selfIntroHelp: 'Write this in the language of the guests you want to show it to.\nExample: if you want Korean guests to read it, write it in Korean.',
    ...
    idUploadHelpBody: 'Your ID is only used for application review, identity verification, and payouts, and it is never shown to guests.',
    ...
    payoutGuideBody: 'Your bank details are directly tied to settlement. If the bank name, account number, or account holder is incorrect, payouts can be delayed. An account in your own name is the safest option. 20% of the experience price you set is applied as the platform fee.',
    ...
    step8Summary3: 'Your actual hosting should match what you register so guest trust remains intact.',
  ...
  ja: {
    ...
    phoneLabel: '携帯電話番号',
    phonePlaceholder: '010-1234-5678',
    phoneHelp: '運営チームが重要な予定変更時に連絡できる番号です。',
    emailLabel: 'メールアドレス',
    emailPlaceholder: 'example@gmail.com',
    instagramLabel: 'Instagram ID',
    instagramPlaceholder: '@locally.host',
    ...
    selfIntroLabel: '自己紹介',
    selfIntroHelp: '見せたいゲストの言語で作成してください。\n例：韓国人ゲストに見せたい場合は韓国語で作成してください。',
    ...
    idUploadHelpBody: '身分証は承認審査と本人確認、および精算のためにのみ使用され、ゲストには公開されません。',
    ...
    payoutGuideBody: '口座情報は収益精算に直接使われます。銀行名、口座番号、名義が実際の情報と異なると支払いが遅れることがあります。本人名義の口座を正確に入力することが重要です。設定した体験料金の20%はプラットフォーム手数料として反映されます。',
    ...
    step8Summary3: '登録内容と実際の運営内容をできるだけ一致させることで、ゲストの信頼が保たれます。',
  ...
  zh: {
    ...
    phoneLabel: '手机号码',
    phonePlaceholder: '010-1234-5678',
    phoneHelp: '这是运营团队在重要日程变更时可以联系您的号码。',
    emailLabel: '电子邮箱',
    emailPlaceholder: 'example@gmail.com',
    instagramLabel: 'Instagram ID',
    instagramPlaceholder: '@locally.host',
    ...
    selfIntroLabel: '自我介绍',
    selfIntroHelp: '请使用你想展示给游客看的语言来填写。\n例：如果你想给韩国游客看，就用韩语来写。',
    ...
    idUploadHelpBody: '证件仅用于审核、身份确认和结算，不会展示给游客。',
    ...
    payoutGuideBody: '账户信息会直接用于收益结算。若银行名、账号或户名与实际不一致，打款可能延迟。最重要的是使用本人名义并准确填写。您设置的体验价格的20%将作为平台服务费。',
    ...
    step8Summary3: '请尽量让注册内容与实际接待内容保持一致，这样才能维持游客的信任。',
