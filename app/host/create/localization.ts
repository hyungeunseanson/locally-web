...
const EXPERIENCE_FORM_COPY: Record<FormLocale, ExperienceFormCopy> = {
  ko: {
    ...
    privatePriceHelp: '단독 투어 가격은 한 팀 기준 고정가입니다. 처음 설정할 때는 3인 예약 총액을 기준으로 잡는 것을 권장합니다.',
  ...
  en: {
    ...
    privatePriceHelp: 'Private tour pricing is a fixed price for one booking group. For your first setup, we recommend using the total price of a 3-person booking as the reference.',
    privatePricePlaceholder: '120,000',
  ...
  ja: {
    ...
    privatePriceHelp: 'プライベートツアー料金は1組あたりの固定料金です。初めて設定する場合は、3名予約の合計金額を基準にすることをおすすめします。',
    privatePricePlaceholder: '120,000',
  ...
  zh: {
    ...
    privatePriceHelp: '私人团价格是按一个预订团队计算的固定总价。首次设置时，建议以3人预订的总额作为参考。',
    privatePricePlaceholder: '120,000',
    step8Title: '体验提交完成！ 🎉',
