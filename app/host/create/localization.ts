...
const EXPERIENCE_FORM_COPY: Record<FormLocale, ExperienceFormCopy> = {
  ko: {
    ...
    photoHelp: '첫 사진은 예약 전환에 가장 큰 영향을 주는 이미지예요. 대표사진에는 호스트 본인 얼굴이 나온 사진을 최소 1장 이상 꼭 포함해주세요.',
  ...
  en: {
    ...
    photoHelp: 'Your first hero photo has the biggest impact on bookings. Please include at least one hero photo where the host’s face is clearly visible.',
  ...
  ja: {
    ...
    photoHelp: '最初の代表写真は予約転換に最も大きく影響します。代表写真には、ホスト本人の顔が分かる写真を最低1枚は必ず含めてください。',
  ...
  zh: {
    ...
    photoHelp: '第一张代表照片最影响预订转化。代表照片中请至少包含一张能清楚看到房东本人脸部的照片。',
