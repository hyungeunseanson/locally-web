...
function getMembershipMilestoneCopy(status: Extract<LocallyMembershipStatus, 'member' | 'circle'>) {
  if (status === 'circle') {
    return {
      ...
      title: '🌙 Locally Circle에 오신 것을 환영합니다',
      message: '다시 찾아와 주셔서 감사합니다. 더 가까운 케어와 우선 안내가 이어집니다.',
      emailSubject: '[Locally] Locally Circle에 오신 것을 환영합니다',
      emailTitle: '이제 Locally Circle입니다',
      emailMessage:
        '다시 찾아와 주셔서 감사합니다. 이제 Locally Circle 고객으로 더 가까운 케어와 우선 안내를 받을 수 있습니다.',
    };
  }

  return {
    type: 'member_welcome' as const,
    title: '✨ Locally Member가 되었습니다',
    message: '첫 구매가 완료되며 로컬리와의 연결이 시작됐어요.',
    emailSubject: '[Locally] Locally Member가 되었습니다',
    emailTitle: '이제 Locally Member입니다',
    emailMessage:
